 ...
 * on the distance from the line that connects the production and injection points.
 * The apertures are calculated and scaled according to
 * a generalized sigmoid function
 */
class CapsuleApertureAux_t : public AuxKernel
{
public:
  static InputParameters validParams();

  CapsuleApertureAux_t(const InputParameters &parameters);
