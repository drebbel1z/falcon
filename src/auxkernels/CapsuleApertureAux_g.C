#include "CapsuleApertureAux_g.h"

registerMooseObject("FalconApp", CapsuleApertureAux_g);

InputParameters
CapsuleApertureAux_g::validParams()
{
...
CapsuleApertureAux_g::CapsuleApertureAux_g(const InputParameters &parameters)
...
Real CapsuleApertureAux_g::computeValue()
{
